...
def test_create_client_signer_validation(url: str, private_keys: list[str]):
    ...
    assert opts_signer_from_private_key.signer.key.to_0x_hex() == private_keys[0]
    ...
    assert (
        opts_linked_signer_from_private_key.linked_signer.key.to_0x_hex() == private_keys[1]
    )
    ...
    assert opts_signer_from_account.signer.key.to_0x_hex() == private_keys[0]
    ...
    assert opts_linked_signer_from_account.linked_signer.key.to_0x_hex() == private_keys[1]
